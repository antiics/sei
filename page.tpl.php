            ...
            <div id="featured"> 
                ...
                <?php if (theme_get_setting('highlighted_display','simplecorp')): ?>
                    ...
                    <div class="container clearfix">
                        ...
                        <!--featured-item -->
                        <div class="one-half">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/featured/data-structure.png" class="img-align-left" alt="" />
                        ...
                        <div class="one-half last">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/featured/algorithms.png" class="img-align-left" alt="" />
                            <h3>Algorithms</h3>
                    ...
                    <div class="container clearfix">
                        ...
                        <!--featured-item -->
                        <div class="one-half">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/featured/object-oriented.png" class="img-align-left" alt="" />
                        ...
                        <!--featured-item -->
                        <div class="one-half last">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/featured/design-patterns.png" class="img-align-left" alt="" />
                    ...
                    <div class="container clearfix">
                        ...
                        <!--featured-item -->
                        <div class="one-half last">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'simplecorp') ;?>/images/featured/languages.png" class="img-align-left" alt="" />
                            <h3>Languages</h3>
